       ...
       <RevealOnScroll>
          <div className=' text-center px-4'>
            ...
            <div className="flex justify-center items-center  space-x-4  ">  
                ...
                className="px-6 py-3   font-medium text-white rounded transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]">View Projects</a>
                <a href="#contact"
                style={{
                  
                  boxShadow: `0 0 10px ${currentColor}CC`,
                }}
                className=" border border-blue-500/50 px-6 py-3 rounded font-medium transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.5)] hover:bg-blue-500/10">Contact Me</a>
