        ...
        <RevealOnScroll>
            <div className="w-150 mx-auto px-5">
                ...
                <form  className="space-y-6" onSubmit={handlesubmit} >
                    ...
                    <button  type="submit" className="w-full bg-blue-500  text-white text-md px-6 py-3 rounded-md font-medium transition relative overflow-hidden hover:-translate-y-1 duration-300 hover:shadow-[0_0_15px_rgba(59,130,246,0.6)] ">
                        Send Message
                    </button>
